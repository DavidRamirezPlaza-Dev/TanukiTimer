...
class timerCasual : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_timer_casual)


        timerTextView = findViewById(R.id.timerTextViewCasual)
        val btnComenzarMesaMitosC = findViewById<ImageButton>(R.id.btnComenzarMesaMitosC)
