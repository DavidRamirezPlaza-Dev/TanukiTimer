...
class timerPokemonCasual : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_timer_pokemon_casual)

        timerTextView = findViewById(R.id.timerTextViewPokemonCasual)
        val btnComenzarMesaPokemonCasual = findViewById<ImageButton>(R.id.btnComenzarMesaPokemonC)
        btnComenzarMesaPokemonCasual.setOnClickListener {
            if(!timerRunning){
